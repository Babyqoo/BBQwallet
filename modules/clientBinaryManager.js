...
const ClientBinaryManager = require('baboqoo-client-binaries').Manager;
const EventEmitter = require('events').EventEmitter;

const log = require('./utils/logger').create('ClientBinaryManager');


// should be       'https://raw.githubusercontent.com/babyqoo/BBQwallet/master/clientBinaries.json'
const BINARY_URL = 'https://raw.githubusercontent.com/babyqoo/BBQwallet/master/clientBinaries.json';
