...
let menuTempl = function (webviews) {
                ...
                submenu: [
                    {
                        ...
                        click() {
                            ...
                            // geth
                                ...
                                if (process.platform === 'darwin') {
                                    userPath += '/Library/BaboQoo/keystore';
                                }

                                if (process.platform === 'freebsd' ||
                                process.platform === 'linux' ||
                                process.platform === 'sunos') {
                                    userPath += '/.baboqoo/keystore';
                                }

                                if (process.platform === 'win32') {
                                    userPath = `${Settings.appDataPath}\\BaboQoo\\keystore`;
                                }
                            }
    ...
    helpMenu.push({
        ...
        click() {
            shell.openExternal('https://github.com/Babyqoo/BBQwallet/wiki');
        },
    }, {
        label: i18n.t('mist.applicationMenu.help.gitter'),
        click() {
            shell.openExternal('https://gitter.im/babyqoo/BBQwallet');
        },
    }, {
        label: i18n.t('mist.applicationMenu.help.reportBug'),
        click() {
            shell.openExternal('https://github.com/Babyqoo/BBQwallet/issues');
        },
    });
