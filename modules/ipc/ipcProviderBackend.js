...
/**
The IPC provider backend filter and tunnel all incoming request to the baboqoo node.
...
class IpcProviderBackend {
                            ...
                            return new Q((resolve, reject) => {
                                const onStateChange = (newState) => {
                                    if (ethereumNode.STATES.CONNECTED === newState) {
                                        ...
                                        log.debug(`BaboQoo node connected, resume connecting socket ${ownerId}`);
    ...
    /**
     * Handler for when BaboQoo node state changes.
     *
     * Auto-reconnect sockets when baboqoo node state changes
     *
    ...
    _onNodeStateChanged(state) {
        ...
        case ethereumNode.STATES.STOPPING:
            log.info('BaboQoo node stopping, disconnecting sockets');
